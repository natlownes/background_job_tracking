module BackgroundJobTracking
  class Config
    ...
    def job_creation_method_name
      name = generated_callback_method_name_prefix + self.options[:method_name].to_s
      name.to_sym
    end

    def job_rescheduling_method_name
      generated_rescheduling_callback_method_name_prefix + self.options[:method_name].to_s
    end
    ...
    def generated_callback_method_name_prefix
      "background_job_creation_tracking_callback_for_"
    end

    def generated_rescheduling_callback_method_name_prefix
